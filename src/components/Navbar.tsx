      ...
      <div className="mobile-navbar" ref={menuRef}>
        ...
        {isOpen && (
          <div className="mobile-menu">
            ...
            <button
            className={isActive("/student/Instruction")}
            onClick={() => handleNavigate("/student/Instruction")}
          >
                  <svg className="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} aria-hidden>
            ...
            >
                  <svg className="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} aria-hidden>
                    ...
                    <path d="M9 5H5a2 2 0 00-2 2v10a2 2 0 002 2h4" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
              Logout
            </button>
          </div>
